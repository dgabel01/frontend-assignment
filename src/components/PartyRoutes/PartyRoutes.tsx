...
const PartyRoutes = () => {
  ...
  const partyRoutes = [
    { title: "Party Route", price: "€750/person", img: partyRoutePhoto, party: 80, adventure: 60 },
    { title: "Ultra Route", price: "€820/person", img: ultraRoutePhoto, party: 90, adventure: 50 },
    { title: "Greece Route", price: "€710/person", img: greeceRoutePhoto, party: 70, adventure: 85 },
    { title: "Adventure Route", price: "€890/person", img: adventureRoutePhoto, party: 60, adventure: 90 },
  ];
  ...
  return (
    <main>
      ...
      <div className="w-full flex flex-col items-center justify-center py-16 bg-white">
        <div className="w-[608px] h-[205px] flex flex-col justify-start items-center gap-6">
          ...
          <div className="flex flex-col justify-start items-center gap-6 w-full">
            <div className="text-center text-[#062949] text-[36px] sm:text-[46px] font-semibold leading-[46px]">
              Whether it&apos;s a bash or <br />
              bliss — the choice is yours
            </div>
            <div className="text-center text-[#062949] text-base font-normal leading-none">
              On our customized sailing adventures, embracing the thrill of our party routes or
              unwinding on our relaxing voyages — crafting your perfect journey at sea has never been
              easier
            </div>
          </div>
        </div>
