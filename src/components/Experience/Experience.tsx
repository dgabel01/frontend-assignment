...
const Experience = () => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center justify-center py-16 bg-[#06283D]">
      ...
      <div className="h-[42px] flex flex-col md:flex-row justify-around items-center w-full max-w-6xl gap-8 mt-12">
        {reviewIcons.map((icon, index) => (
          <div className="relative flex items-center gap-4" key={index}>
            <Image
              src={icon}
              alt={`Review Icon ${index + 1}`}
              width={42}
              height={42}
            />
      ...
      <div className="w-full max-w-6xl mt-48 px-4">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="w-full max-w-xl text-white text-base sm:text-lg font-normal font-['DM Sans'] whitespace-normal leading-snug">
